...
async function storefrontApiRequest(query: string, variables: any = {}) {
  const response = await fetch(`https://shoe-shop-cart-6o9mr.myshopify.com/api/2025-07/graphql.json`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'X-Shopify-Storefront-Access-Token': 'd8dfa3dd49d3dd3c545bed14c80da825'
    },
